...
\begin{physbox}
% ── 1. What is ZVS and why does it matter ────────────────────────────────────
\textbf{1.\ What is zero-voltage switching (ZVS) and why does it matter?}
...
\medskip
% ── 2. Geometric condition R ≥ Vdc/2 ─────────────────────────────────────────
\textbf{2.\ Why must $R \geq \Vdc/2$? — a geometric argument.}
...
\medskip
% ── 3. Role of the boost phase ───────────────────────────────────────────────
\textbf{3.\ Why is a boost phase needed?}
...
\medskip
% ── 4. Why Cr must be small ──────────────────────────────────────────────────
\textbf{4.\ Why must $\Cr$ be kept small? — a design trade-off.}
