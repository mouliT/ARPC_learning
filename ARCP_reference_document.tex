...
The ARCP adds an \textbf{auxiliary resonant branch} to a standard inverter pole leg:
\begin{itemize}
    ...
    \item \textbf{Auxiliary resonant inductor}: $\Lr$ — center leg, carries
          resonant current $\ir$
    \item \textbf{Auxiliary switches}: $A_1$ (connected to $+\Vdc/2$) and
          $A_2$ (connected to $-\Vdc/2$) — fire briefly to initiate the
          resonant swing
